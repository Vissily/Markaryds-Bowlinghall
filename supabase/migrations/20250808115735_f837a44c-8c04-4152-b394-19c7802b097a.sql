...
CREATE POLICY IF NOT EXISTS "Public can view gallery and event images"
ON storage.objects
FOR SELECT
...
CREATE POLICY IF NOT EXISTS "Users can upload to own folder (gallery/event)"
ON storage.objects
...
CREATE POLICY IF NOT EXISTS "Owner or admin can update files (gallery/event)"
ON storage.objects
...
CREATE POLICY IF NOT EXISTS "Owner or admin can delete files (gallery/event)"
ON storage.objects
