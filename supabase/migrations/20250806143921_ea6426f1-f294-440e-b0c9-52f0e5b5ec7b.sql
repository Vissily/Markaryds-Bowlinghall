...
-- Restrict upload and delete operations to authenticated users only
...
-- Policy for updating images (only uploaders or admins)
...
-- Policy for deleting images (only uploaders or admins)
